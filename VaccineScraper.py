...
# ------------------- E-mail list ------------------------
toAddress = ['EMAIL 1','EMAIL 2','EMAIL 3']
# --------------------------------------------------------
...
# Count number of "Full" occurrences, then number of "Appointments
...
if openSlot == True:
    ...
    conn.login('YOUR GMAIL', 'YOUR AUTH KEY')
    conn.sendmail('YOUR GMAIL', toAddress, 'Subject: Potential Opening\n\nHi Amma and Abba\n\nThe script has detected a change, there may be an appointment available.\n\nThis is an automated message.\nVaccine Scraper V1.0')
    conn.quit()
